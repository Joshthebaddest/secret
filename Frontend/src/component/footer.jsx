        ...
        <>
            <footer>
                <p>Thank you for visiting my website! you can check out my 
                    <a style={{textDecoration : "underline", color: "rgb(61, 20, 195)"}} href="https://joshportfolio-eight.vercel.app"> portfolio </a> 
                    ...
                    <a style={{textDecoration: "underline", color: "green"}} href="https://wa.me/message/57IXET2G6T44L1"><i className="fa-brands fa-whatsapp" style={{marginRight: "5px"}}></i> whatsapp </a> 
